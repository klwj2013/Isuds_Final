...
export class FAQComponent implements OnInit {
  ...
  questionAnswerList: QuestionAnswer[] = [
    ...
    { question: "Where are your products made?", answer: "Our hardware and software is owned and created by PourMyBeer We chose to partner with a company in Austria on building the custom hardware and software so that we can build a system custom to each business. With continued growth, there are various elements of the product being made by several teams spread out around the United States and Austria."},
